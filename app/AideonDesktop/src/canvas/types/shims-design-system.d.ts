...
declare module '../../design-system/components/ui/button' {
  export const Button: ComponentType<any>;
  export const buttonVariants: Record<string, unknown>;
}

declare module '../../design-system/components/ui/accordion' {
...
declare module '../../design-system/components/ui/badge' {
  export const Badge: ComponentType<any>;
}

declare module '../../design-system/components/ui/alert' {
...
declare module '../../design-system/components/ui/scroll-area' {
  export const ScrollArea: ComponentType<any>;
}

declare module '../../design-system/components/ui/input' {
  export const Input: ComponentType<any>;
}

declare module '../../design-system/ui/button' {
  export const Button: ComponentType<any>;
  export const buttonVariants: Record<string, unknown>;
}

declare module '../../design-system/components/ui/card' {
...
declare module '../../design-system/ui/table' {
...
declare module '../../design-system/components/ui/table' {
  export const Table: ComponentType<any>;
  export const TableBody: ComponentType<any>;
  export const TableCell: ComponentType<any>;
  export const TableHead: ComponentType<any>;
...
declare module '../../design-system/blocks/panel' {
...
declare module '../../design-system/components/ui/select' {
...
declare module '../../design-system/components/ui/slider' {
  export const Slider: ComponentType<any>;
}

declare module '../../design-system/components/ui/toggle-group' {
  export const ToggleGroup: ComponentType<any>;
  export const ToggleGroupItem: ComponentType<any>;
}

declare module '../../design-system/components/ui/command' {
...
declare module '../../design-system/components/ui/dialog' {
...
declare module '../../design-system/lib/utils' {
  export function cn(...classes: unknown[]): string;
}

declare module '../../design-system/reactflow/node-search' {
  export const NodeSearchDialog: ComponentType<any>;
}

declare module '../../design-system/reactflow/praxis-node' {
  export const PraxisNode: ComponentType<any>;
}

declare module '../../design-system/reactflow/timeline-edge' {
  export const TimelineEdge: ComponentType<any>;
  export type TimelineEdgeData = Record<string, unknown>;
}

declare module '../../design-system/styles/globals.css' {
  const css: string;
  export default css;
}
