...
const COMMANDS = {
  upsertMetamodelBatch: 'mneme_store_upsert_metamodel_batch',
  compileEffectiveSchema: 'mneme_store_compile_effective_schema',
  getEffectiveSchema: 'mneme_store_get_effective_schema',
  listEdgeTypeRules: 'mneme_store_list_edge_type_rules',
  createNode: 'mneme_store_create_node',
  createEdge: 'mneme_store_create_edge',
  setEdgeExistenceInterval: 'mneme_store_set_edge_existence_interval',
  tombstoneEntity: 'mneme_store_tombstone_entity',
  setPropertyInterval: 'mneme_store_set_property_interval',
  clearPropertyInterval: 'mneme_store_clear_property_interval',
  orSetUpdate: 'mneme_store_or_set_update',
  counterUpdate: 'mneme_store_counter_update',
  readEntityAtTime: 'mneme_store_read_entity_at_time',
  traverseAtTime: 'mneme_store_traverse_at_time',
  listEntities: 'mneme_store_list_entities',
  getProjectionEdges: 'mneme_store_get_projection_edges',
  getGraphDegreeStats: 'mneme_store_get_graph_degree_stats',
  getGraphEdgeTypeCounts: 'mneme_store_get_graph_edge_type_counts',
  storePageRankRun: 'mneme_store_store_pagerank_scores',
  getPageRankScores: 'mneme_store_get_pagerank_scores',
  exportOps: 'mneme_store_export_ops',
  ingestOps: 'mneme_store_ingest_ops',
  getPartitionHead: 'mneme_store_get_partition_head',
  createScenario: 'mneme_store_create_scenario',
  deleteScenario: 'mneme_store_delete_scenario',
  exportOpsStream: 'mneme_store_export_ops_stream',
  importOpsStream: 'mneme_store_import_ops_stream',
  exportSnapshotStream: 'mneme_store_export_snapshot_stream',
  importSnapshotStream: 'mneme_store_import_snapshot_stream',
  upsertValidationRules: 'mneme_store_upsert_validation_rules',
  listValidationRules: 'mneme_store_list_validation_rules',
  upsertComputedRules: 'mneme_store_upsert_computed_rules',
  listComputedRules: 'mneme_store_list_computed_rules',
  upsertComputedCache: 'mneme_store_upsert_computed_cache',
  listComputedCache: 'mneme_store_list_computed_cache',
  triggerRebuildEffectiveSchema: 'mneme_store_trigger_rebuild_effective_schema',
  triggerRefreshIntegrity: 'mneme_store_trigger_refresh_integrity',
  triggerRefreshAnalyticsProjections: 'mneme_store_trigger_refresh_analytics_projections',
  triggerRetention: 'mneme_store_trigger_retention',
  triggerCompaction: 'mneme_store_trigger_compaction',
  runProcessingWorker: 'mneme_store_run_processing_worker',
  listJobs: 'mneme_store_list_jobs',
  getChangesSince: 'mneme_store_get_changes_since',
  subscribePartition: 'mneme_store_subscribe_partition',
  unsubscribePartition: 'mneme_store_unsubscribe_partition',
  getIntegrityHead: 'mneme_store_get_integrity_head',
  getLastSchemaCompile: 'mneme_store_get_last_schema_compile',
  listFailedJobs: 'mneme_store_list_failed_jobs',
  getSchemaManifest: 'mneme_store_get_schema_manifest',
  explainResolution: 'mneme_store_explain_resolution',
  explainTraversal: 'mneme_store_explain_traversal',
} as const;
