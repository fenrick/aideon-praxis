...
describe('PraxisShellLayout storage', () => {
  beforeEach(() => {
  ...
  it('reads stored layout when valid and tolerates invalid JSON', () => {
    ...
    expect(getItem).toHaveBeenCalledWith('praxis-shell-panels');
  });
  ...
  it('writes layout sizes when storage allows, and ignores write failures', () => {
    ...
    expect(setItem).toHaveBeenCalledWith('praxis-shell-panels', JSON.stringify([18, 62, 20]));
