...
export function AnimatedSvgEdge({
  ...
  return (
    <>
      ...
      <Shape animateMotionProperties={animateMotionProperties} />
    </>
  );
}
...
interface AnimatedSvgProperties {
  readonly animateMotionProperties: AnimateMotionProperties;
}

type AnimatedSvg = (properties: AnimatedSvgProperties) => ReactElement;

const shapes = {
  circle: ({ animateMotionProperties }: AnimatedSvgProperties) => (
    <circle r="5" fill="#ff0073">
      <animateMotion {...animateMotionProperties} />
    </circle>
  ),

  package: ({ animateMotionProperties }: AnimatedSvgProperties) => (
...
function getAnimateMotionProperties({
  ...
  switch (direction) {
    ...
    case 'alternate': {
      const doubledDuration = duration * 2;
      return {
        ...shared,
