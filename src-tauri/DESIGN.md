...
`src-tauri/src/` must be organised by responsibility, not by “whatever was added next”.
...
This aligns with `DESIGN.md` and extends it to support more modules and long-lived complexity.
