...
- All shadcn/ui and React Flow UI primitives sit inside `app/AideonDesktop/src/design-system/src/ui` or
  ...
  `pnpm --filter @aideon/desktop run components:refresh` (pulls shadcn defaults plus the
...
| -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| Time control panel (`app/AideonDesktop/src/canvas/components/blocks/time-control-panel.tsx`) | `Panel`, `PanelField`, `PanelToolbar`, shadcn `Select`/`Slider` proxies | ✅ Migrated to the shared panel block; demonstrates field + helper usage and action toolbar.       |
