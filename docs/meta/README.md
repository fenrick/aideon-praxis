...
`crates/aideon-praxis-engine/src/meta_seed.rs` contains the code representation of this schema. When a new
...
The SQLite persistence layer now runs through SeaORM/SeaQuery 1.1.19 located in `crates/aideon-mneme-core`.
