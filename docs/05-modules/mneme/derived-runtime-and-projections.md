...
4. Sync-in-tx projections (indexes, projection edges, change feed) are rebuilt inline as each op replays; near-real-time and batch artefacts (effective-schema cache, PageRank, integrity) are enqueued.
