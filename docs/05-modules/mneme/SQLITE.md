...
| Table                      | Purpose                                                                                                                                                                                                                                                                                                      |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `aideon_entities`          | Entity rows; PK `(partition_id, entity_id)`, scenario overlay via `scenario_id`; `entity_kind`, `type_id` (nullable), `is_deleted`, `acl_group_id` (nullable), `owner_actor_id` (nullable), `visibility` (nullable), `created_op_id`, `updated_op_id`, `created_asserted_at_hlc`, `updated_asserted_at_hlc`. |
