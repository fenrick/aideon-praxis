...
| ------------------------------------------------------------------- | ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| The default EA metamodel and business vocabulary                    | [Praxis](../praxis/README.md)       | Praxis authors a `MetamodelBatch`; Mneme persists and compiles it as schema-as-data ([METAMODEL-PACKAGES](../../03-design/METAMODEL-PACKAGES.md)). |
