...
- Import is deterministic and reviewable before it commits; export is deny-by-default with redaction ([hig/import-and-export.md](../../03-design/hig/import-and-export.md)).
- Mapping reports and exceptions render with the honest-state vocabulary ([error-loading-empty.md](../error-loading-empty.md)).
