...
- **React**: `app/AideonDesktop/tests/praxis/components/commit-timeline-card.test.tsx` and
  `app/AideonDesktop/tests/praxis/time/use-temporal-panel.test.ts` show how to mock `praxisApi` and assert
