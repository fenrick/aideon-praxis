...
| Topic                    | File                                                                         |
| ------------------------ | ---------------------------------------------------------------------------- |
| Metis analytics engine   | [analytics/metis-analytics.md](./analytics/metis-analytics.md)               |
| Determinism and bounds   | [analytics/determinism-and-bounds.md](./analytics/determinism-and-bounds.md) |
| Usage telemetry (opt-in) | [analytics/usage-telemetry.md](./analytics/usage-telemetry.md)               |
