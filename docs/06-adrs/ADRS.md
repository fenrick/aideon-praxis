...
| [0040](./ADR-0040-m0-host-validation-gate-and-proof-carrying-readiness.md)       | M0 host-validation gate — two-tier in-window strategy + proof-carrying readiness             | Accepted | Stable seam + invariant   |
| [0041](./ADR-0041-token-contract-reconciliation-dtcg-source-shadcn-generated.md) | Design-token contract reconciliation — DTCG source authoritative, shadcn variables generated | Accepted | Invariant                 |
