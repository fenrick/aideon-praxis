...
describe('health helpers', () => {
  it('httpHealthOverUds returns ok', async () => {
    httpRequestMock.mockImplementation((_options: unknown, callback: (responseArgument: any) => void) => {
  ...
  it('waitForServerReady times out on errors', async () => {
    httpRequestMock.mockImplementation((_options: unknown, _callback: (responseArgument: any) => void) => {
