# Aideon Desktop — agent instructions

The canonical guidance for AI coding assistants in this repository lives in the root `CLAUDE.md` file. Read it first —
it is the authoritative router for the project invariants, the domain glossary, the task workflow and quality gates, the
