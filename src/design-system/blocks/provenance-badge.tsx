...
const provenanceSpecs: Record<ProvenanceClassification, ProvenanceSpec> = {
  asserted: {
    className: 'border-provenance-asserted/20 bg-provenance-asserted-soft text-provenance-asserted',
    icon: Pencil,
    label: 'Asserted',
  },
  generated: {
    className: 'border-provenance-generated/20 bg-provenance-generated-soft text-provenance-generated',
    icon: Sparkles,
    label: 'Generated',
  },
  inferred: {
    className: 'border-provenance-inferred/20 bg-provenance-inferred-soft text-provenance-inferred',
    icon: CircleDot,
    label: 'Inferred',
  },
};
...
export function ProvenanceBadge({ classification, className }: ProvenanceBadgeProperties) {
  const spec = provenanceSpecs[classification];
