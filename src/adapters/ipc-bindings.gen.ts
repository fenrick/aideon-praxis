...
export type CanvasLayoutGetRequest = { docId: string }
export type CanvasLayoutSaveRequest = { docId: string; nodes?: CanvasNode[]; edges?: CanvasEdge[]; groups?: CanvasGroup[] }
...
export type GraphLayoutGetRequest = { docId: string; widgetId: string }
export type GraphLayoutNode = { id: string; x: number; y: number }
export type GraphLayoutSaveRequest = { docId: string; widgetId: string; nodes?: GraphLayoutNode[] }
